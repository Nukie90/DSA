...
import code.Puzzle8_651306;
import code.Puzzle8State_651306;
...
public class lab14 {
    ...
    static void demo1(){
        Puzzle8_651306 game = new Puzzle8_651306(new int[] {9,0,0,1,0,1,3,0,2,4,1,0,2,1,1,5,1,2,7,2,0,8,2,1,6,2,2} );
        game.displayBoard();
    }
    ...
    static void demo3(){
        ...
        for (Puzzle8State_651306 s : game.explored){
